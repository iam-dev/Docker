...
<head>
<meta charset="UTF-8">
<title>Dockerfile example for Apache 2 on Ubuntu 17.10</title>
...
<body>
    ...
    <main>
        <section class="jumbotron text-center">
            <div class="container">
                <h1 class="jumbotron-heading">Default page</h1>
                <p class="lead text-muted">Dockerfile example for Apache 2 on Ubuntu 17.10.
                </p>
                <p>
